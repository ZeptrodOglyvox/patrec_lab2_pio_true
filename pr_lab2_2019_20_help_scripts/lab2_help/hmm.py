...
def gmm_hmm(X, trans_mat, starts, data, n_states=2, n_mixtures=2, gmm=True):
    ...
    # data = []  # your data: must be a Python list that contains: 2D lists with the sequences
    # (so its dimension would be num_sequences x seq_length x feature_dimension)
